# 训练集标注文件的路径
train_ann_path = "../../coco2017/annotations/instances_train2017.json"
# 训练集图片文件夹的路径
train_img_path = "../../coco2017/train2017"
# 训练集标注文件的路径
val_ann_path = "../../coco2017/annotations/instances_val2017.json"
# 训练集图片文件夹的路径
val_img_path = "../../coco2017/val2017"
# 保存checkpoint的文件夹的路径
